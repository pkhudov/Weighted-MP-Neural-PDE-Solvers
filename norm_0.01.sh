...
# -N euclidean+normalised-sigma-0.01
...
python experiments/train.py --device=cuda:0 --experiment=E1 --neighbors=6 --unrolling=2 --sigma=0.01 --lr=1e-4 --smoothing=euclidean+normalised --print_interval=50 --log=True
