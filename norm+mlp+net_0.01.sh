...
python experiments/train.py --device=cuda:0 --experiment=E1 --neighbors=6 --unrolling=2 --sigma=0.01 --lr=1e-4 --smoothing=norm+mlp+net --print_interval=20 --log=True
