...
# -N norm+mlp+product-sigma-0.0005
# Runtime limit of 38 hours:
#$ -l h_rt=47:00:00
#
...
python experiments/train.py --device=cuda:0 --experiment=E1 --neighbors=6 --unrolling=2 --sigma=0.0005 --lr=1e-4 --smoothing=norm+mlp+product --log=True
